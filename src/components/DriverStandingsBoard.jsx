...
export const DriverStandingsBoard = ({ diverStandings }) => {
    return (
        <section id="driversStandingsBoard" className="w-1/2 m-2 p-2 bg-gray-300 h-full">
            <h2 className="text-center font-bold pt-4">Drivers</h2>
                        ...
                        {diverStandings.map((s) => {
                            return (
                                <tr key={s.position} className="hover:bg-gray-400 transition-all duration-200">
                                    ...
                                    <td className="text-sm">{`${s.drivers.forename} ${s.drivers.surname}`}</td>
