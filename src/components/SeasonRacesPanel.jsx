...
const SeasonRacesPanel = ({seasonRaces, year}) => {
    ...
    return (
        <section id="racesPanel" className="left-0 w-1/3 pb-4 bg-gray-200 h-5/6">
                            ...
                            return (
                                <tr key={r.raceId} className="hover:bg-gray-300 transition-all duration-200">
                                    ...
                                    <td className="text-right pr-4">
                                        <Button styles={{normal: ["bg-blue-500 text-white mx-2 my-0.5"], hover: ["bg-blue-600", "shadow-lg"], focus: ["bg-blue-600", "shadow-lg"], transitionDuration: 100}}>Results</Button>
